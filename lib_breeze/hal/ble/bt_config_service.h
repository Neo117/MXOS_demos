...
#define BT_CONFIG_WC_RW_INDEX            4
#define BT_CONFIG_WWNRC_RW_INDEX         9

#define BT_CONFIG_IC_CCCD_INDEX          7
#define BT_CONFIG_NC_CCCD_INDEX          12
...
extern T_SERVER_ID bt_config_service_id;
