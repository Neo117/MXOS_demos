...
#define MXKIT_LOG_UART_RXD MODULE_PIN_34
#define MXKIT_LOG_UART_TXD MODULE_PIN_35

/* MXKit APP UART */
#define MXKIT_APP_UART UART_3
#define MXKIT_APP_UART_RXD MODULE_PIN_11
#define MXKIT_APP_UART_TXD MODULE_PIN_12
#define MXKIT_APP_UART_RTS MODULE_PIN_NC
#define MXKIT_APP_UART_CTS MODULE_PIN_NC

/* MXKit Mode Pins */
#define MXKIT_BOOT_PIN MODULE_PIN_6
#define MXKIT_STATUS_PIN MODULE_PIN_7
#define MXKIT_ELINK_PIN MODULE_PIN_NC

/* MXKit Extention Connector */
#define MXKIT_UART MXKIT_APP_UART
#define MXKIT_I2C I2C_NC
...
#define MXKIT_D7 MODULE_PIN_NC

#define MXKIT_D8 MODULE_PIN_13
#define MXKIT_D9 MODULE_PIN_10
#define MXKIT_CS MODULE_PIN_7
#define MXKIT_MOSI MODULE_PIN_9
#define MXKIT_MISO MODULE_PIN_8
#define MXKIT_SCK MODULE_PIN_6
#define MXKIT_SDA MODULE_PIN_30
#define MXKIT_SCL MODULE_PIN_31

#define MXKIT_A0 MODULE_PIN_4
#define MXKIT_A1 MODULE_PIN_5
