...
TOOLS_ROOT ?= $(SOURCE_ROOT)mxos/MiCoder

OPENOCD_PATH      := $(MAKEFILES_PATH)/OpenOCD/openocd/
...
OPENOCD_FULL_NAME := mxos\makefiles\OpenOCD\openocd\Win32\openocd_mxos.exe
...
EXECUTABLE_SUFFIX  :=
OPENOCD_FULL_NAME := "$(OPENOCD_PATH)Linux32/openocd_mxos"
SLASH_QUOTE_START :=\"
SLASH_QUOTE_END   :=\"
ESC_QUOTE         :=\"
ESC_SPACE         :=\$(SPACE)
...
export SHELL       = $(COMMON_TOOLS_PATH)dash
EXECUTABLE_SUFFIX  :=
OPENOCD_FULL_NAME := "$(OPENOCD_PATH)Linux64/openocd_mxos"
SLASH_QUOTE_START :=\"
SLASH_QUOTE_END   :=\"
ESC_QUOTE         :=\"
ESC_SPACE         :=\$(SPACE)
...
export SHELL       = $(COMMON_TOOLS_PATH)dash
EXECUTABLE_SUFFIX  :=
OPENOCD_FULL_NAME := "$(OPENOCD_PATH)OSX/openocd_mxos"
...
##########
# Recurse directories to find valid MXOS components.
