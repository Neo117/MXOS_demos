...
ifneq ($(SDK_TYPE),)
SDK_OUTPUT_FOLDER := MXOS_$(SDK_TYPE)_v$(MXOS_SDK_VERSION)
SDK_OUTPUT_DIR := $(SOURCE_ROOT)$(SDK_OUTPUT_FOLDER)/
SDK_OUTPUT_OSX := $(SOURCE_ROOT)../MXOS_$(SDK_TYPE)_v$(MXOS_SDK_VERSION).macOS.tar.gz
SDK_OUTPUT_Linux64 := $(SOURCE_ROOT)../MXOS_$(SDK_TYPE)_v$(MXOS_SDK_VERSION).Linux64.tar.gz
SDK_OUTPUT_WIN := $(SOURCE_ROOT)../MXOS_$(SDK_TYPE)_v$(MXOS_SDK_VERSION).Win32.zip

ECLIPSE_PROJECT_FILE := $(SDK_OUTPUT_DIR)/.project
comma:= ,


$(info Releasing MXOS SDK v$(MXOS_SDK_VERSION) for $(SDK_TYPE)!)
else
...
BASIC_FILES:	
	...
	$(QUIET)$(call CPDIR, $(SOURCE_ROOT)MXOS 		$(SDK_OUTPUT_DIR)MXOS)
	...
	$(QUIET)$(call WRITE_FILE_APPEND, $(ECLIPSE_PROJECT_FILE) ,	<name>MXOS_$(SDK_TYPE)_v$(MXOS_SDK_VERSION)</name>)
	...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/MXOS/core/*.a
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/MXOS/core/rf_driver/MARVELL_sd8801_P34.bin
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/MXOS/core/rf_driver/MARVELL_sd8801_P70.bin

	$(QUIET)$(ECHO) Remove all MCU libraries...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)platform/MCU
	$(QUIET)$(call MKDIR, $(SDK_OUTPUT_DIR)platform/MCU)
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)platform/MCU/mxos_platform_common.c $(SDK_OUTPUT_DIR)platform/MCU/
	...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/libraries/bluetooth/BTE/mxos
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/libraries/bluetooth/BTE/mxos_bt_api
	...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)MXOS/security/TLS/wolfSSL/wolfssl
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)MXOS/security/TLS/wolfSSL/mxos
	...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)MXOS/security/Sodium/src
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)MXOS/security/SRP_6a/src
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)MXOS/system/easylink/MFi_WAC/src
	...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)document/MXOS_DEV_1
...
A_FILES: $(if $(findstring total,$(MAKECMDGOALS)), BASIC_FILES_WITH_MOCODER, BASIC_FILES) 
	...
	$(QUIET)$(ECHO) Copying MXOS core libraries...
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.1062.*.a $(SDK_OUTPUT_DIR)MXOS/core/
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.3165.*.a $(SDK_OUTPUT_DIR)MXOS/core/
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.3166.*.a $(SDK_OUTPUT_DIR)MXOS/core/
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.3238.*.a $(SDK_OUTPUT_DIR)MXOS/core/
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.3239.*.a $(SDK_OUTPUT_DIR)MXOS/core/
...
B_FILES: $(if $(findstring total,$(MAKECMDGOALS)), BASIC_FILES_WITH_MOCODER, BASIC_FILES)
	...
	$(QUIET)$(ECHO) Copying MXOS core libraries...
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.1088.*.a $(SDK_OUTPUT_DIR)MXOS/core/
...
C_FILES: BASIC_FILES
	...
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/Projects/RTL8711/demo/EWARM/MXOSKit-3081
	$(QUIET)$(RM) -rf $(SDK_OUTPUT_DIR)/Projects/RTL8711/bootloader/EWARM/MXOSKit-3081
	
	$(QUIET)$(ECHO) Copying MXOS core libraries...
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.3081.*.a $(SDK_OUTPUT_DIR)MXOS/core/
	$(QUIET)$(CP) -f  $(SOURCE_ROOT)MXOS/core/*.3081A.*.a $(SDK_OUTPUT_DIR)MXOS/core/
