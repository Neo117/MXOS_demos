...
ifeq (IAR,$(TOOLCHAIN_NAME))
	$(QUIET)$(CC) $(COMPILER_SPECIFIC_COMP_ONLY_FLAG) $(COMPILER_SPECIFIC_DEPS_FLAG) $(RESOURCE_CFLAGS) $(call ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS, ) $($(1)_CFLAGS) -I$(SOURCE_ROOT)include/ -I$(SOURCE_ROOT)MXOS/WWD/include -o $$@ $$< >> $$(IAR_BUILD_RESULTS_FILE)
else
	$(QUIET)$(CC) $(COMPILER_SPECIFIC_COMP_ONLY_FLAG) $(COMPILER_SPECIFIC_DEPS_FLAG) $(RESOURCE_CFLAGS) $(call ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS, ) $($(1)_CFLAGS) -I$(SOURCE_ROOT)include/ -I$(SOURCE_ROOT)MXOS/WWD/include -o $$@ $$<
endif
...
$(OUTPUT_DIR)/libraries/resources.a: $$(RESOURCE_OBJS)
	$(QUIET)$(RM) $$@
	$$(if $$(wordlist 1,50,     $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_CREATE) $$@ $$(wordlist 1,50,     $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 51,100,   $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 51,100,   $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 101,150,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 101,150,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 151,200,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 151,200,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 201,250,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 201,250,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 251,300,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 251,300,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 301,350,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 301,350,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 351,400,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 351,400,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 401,450,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 401,450,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 451,500,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 451,500,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 501,550,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 501,550,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 551,600,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 551,600,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 601,650,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 601,650,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 651,700,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 651,700,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 701,750,  $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 701,750,  $$(RESOURCE_OBJS)))
	$$(if $$(wordlist 751,1000, $$(RESOURCE_OBJS)),$(QUIET)$(AR) $(MXOS_SDK_ARFLAGS) $(COMPILER_SPECIFIC_ARFLAGS_ADD) $$@ $$(wordlist 751,1000, $$(RESOURCE_OBJS)))
...
$(FS_IMAGE): $(RESOURCES_DEPENDENCY)
	$(COMMON_TOOLS_PATH)mk_mxosfs32 $(FS_IMAGE) $(STAGING_DIR)
...
external_resource_downloader:
	...
	$(QUIET)$(MAKE) -r $(SILENT) -f $(SOURCE_ROOT)mxos/makefiles/Makefile $(SFLASH_WRITE_TARGET) NO_BUILD_BOOTLOADER=1 -I$(OUTPUT_DIR)  SFLASH= $(SFLASH_WRITE_REDIRECT)
