...
export MAKEFILES_PATH := $(MXOS_OS_PATH)/makefiles
...
include $(MXOS_OS_PATH)/makefiles/mxosder_host_cmd.mk
include $(MXOS_OS_PATH)/makefiles/mxosder_toolchain_GCC.mk
...
$(SOURCE_ROOT)build/$(NAME)/%.o: %.c $(MAKEFILES_PATH)/mxos_library_makefile.mk
	$(QUIET)$(call MKDIR, $(dir $@))
	$(QUIET)$(ECHO) Compiling $<
	$(QUIET)$(CC) -I $(SOURCE_ROOT)/tools/makefiles -fno-builtin $(LIBRARY_POISON_H_INCLUSION) $(CFLAGS) -o $@ $<
	$(QUIET)$(CC) $(CFLAGS) -o $@ $<

$(SOURCE_ROOT)build/$(NAME)/%.o: %.cpp $(MAKEFILES_PATH)/mxos_library_makefile.mk
	$(QUIET)$(call MKDIR, $(dir $@))
	$(QUIET)$(ECHO) Compiling $<
	$(QUIET)$(CC) $(CFLAGS) -o $@ $<
...
$(SOURCE_ROOT)build/$(NAME)/%.o: %.S $(MAKEFILES_PATH)/mxos_library_makefile.mk
	$(QUIET)$(call MKDIR, $(dir $@))
...
stripped_lib: $(SOURCE_ROOT)build/$(NAME)/$(LIBRARY_NAME).a $(MAKEFILES_PATH)/mxos_library_makefile.mk
ifdef NO_STRIP_LIBS
