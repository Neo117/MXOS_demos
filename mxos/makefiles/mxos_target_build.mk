...
ifeq (emc3080,$(findstring emc3080,$(MAKECMDGOALS)))
	$(QUIET)$(ECHO) emc3080 skip
else
	$(QUIET)$(ECHO) Making $(notdir $@)
...
# $(info prebuild targets:$(MAKECMDGOALS))
# $(info prebuild targets:$(findstring MX3280,$(MAKECMDGOALS)))
