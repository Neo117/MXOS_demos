...
APP_PLATFORM   := $(notdir $(strip $(foreach comp,$(APP_COMPONENTS),$(wildcard $(SOURCE_ROOT)MXOS/platform/$(comp)))))
...
ota_upgrade_app:
	...
	$(QUIET)$(MAKE) $(SILENT) -f $(SOURCE_ROOT)mxos/makefiles/Makefile -s $(OTA_TGT) NO_BUILD_BOOTLOADER=1
	$(QUIET)$(ECHO_BLANK_LINE)
...
sflash_writer_app:
	...
	$(QUIET)$(ECHO_BLANK_LINE)
	$(QUIET)$(MAKE) $(SILENT) -f $(SOURCE_ROOT)mxos/makefiles/Makefile -s $(SFLASHWRITER_TGT) NO_BUILD_BOOTLOADER=1
	$(QUIET)$(ECHO) Done
	$(QUIET)$(ECHO_BLANK_LINE)
