...
$(SFLASH_PREBUILD_APP):
	...
	$(QUIET)$(MAKE) -r -f $(SOURCE_ROOT)mxos/makefiles/Makefile $(SFLASH_APP_TARGET)  SFLASH= EXTERNAL_MXOS_GLOBAL_DEFINES=$(EXTERNAL_MXOS_GLOBAL_DEFINES) SUB_BUILD=sflash_app $(SFLASH_REDIRECT)
