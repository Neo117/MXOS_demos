 ...
 *               IRQ Handler Mapping
 ******************************************************/
MXOS_RTOS_DEFINE_ISR( EXTI0_IRQHandler )
{
  gpio_irq();
}

MXOS_RTOS_DEFINE_ISR( EXTI1_IRQHandler )
{
  gpio_irq();
}

MXOS_RTOS_DEFINE_ISR( EXTI2_IRQHandler )
{
  gpio_irq();
}

MXOS_RTOS_DEFINE_ISR( EXTI3_IRQHandler )
{
  gpio_irq();
}

MXOS_RTOS_DEFINE_ISR( EXTI4_IRQHandler )
{
  gpio_irq();
}

MXOS_RTOS_DEFINE_ISR( EXTI9_5_IRQHandler )
{
  gpio_irq();
}

MXOS_RTOS_DEFINE_ISR( EXTI15_10_IRQHandler )
{
  gpio_irq();
}
