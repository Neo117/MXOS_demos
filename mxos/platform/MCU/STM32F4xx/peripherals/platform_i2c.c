...
#ifdef I2C_USE_DMA
static merr_t i2c_dma_config_and_execute( mhal_i2c_device_t* device, mhal_i2c_message_t* message, bool tx_dma  )
{
  uint32_t counter;
...
static merr_t i2c_dma_transfer( mhal_i2c_device_t* device, mhal_i2c_message_t* message )
{
  merr_t       result;
  uint32_t       counter;
  int            i = 0;
