...
static merr_t wlan_spi_transfer( const mhal_spi_message_segment_t segment );
...
#if defined ( MXOS_WIFI_USE_GPIO_FOR_BOOTSTRAP )
    /* Clear GPIO_B[1:0] */
...
merr_t wlan_spi_transfer( const mhal_spi_message_segment_t segment )
{
    merr_t result;
