EXTRA_POST_BUILD_TARGETS += $(MXOS_ALL_BIN_OUTPUT_FILE) $(OTA_BIN_OUTPUT_FILE)
...
$(OTA_BIN_OUTPUT_FILE):
	$(PYTHON) $(MXOS_OS_PATH)/platform/MCU/mx1270/tools/ota.py $(BIN_OUTPUT_FILE)
	$(PYTHON) $(MXOS_OS_PATH)/makefiles/scripts/add_md5.py $(OTA_BIN_OUTPUT_FILE)
