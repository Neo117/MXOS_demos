...
* MCU-specific data types are defined in <MXOS-SDK>/platform/MCU/<MCU_family>/platform_mcu_peripheral.h
...
#define MXOS_PERIPHERAL_UNSUPPORTED ( 0xFFFFFFFF )
...
merr_t platform_uart_init( platform_uart_driver_t* driver, const platform_uart_t* peripheral, uint32_t baudrate, const mhal_uart_config_t *config);
 ...
 * @return @ref merr_t
 */
merr_t platform_spi_init( platform_spi_driver_t* driver, const platform_spi_t* peripheral, const platform_spi_config_t* config );
 ...
 * @return @ref merr_t
 */
merr_t platform_spi_deinit( platform_spi_driver_t* driver );
 ...
 * @return @ref merr_t
 */
merr_t platform_spi_transfer( platform_spi_driver_t* driver, const platform_spi_config_t* config, const platform_spi_message_segment_t* segments, uint16_t number_of_segments );
 ...
 * @return @ref merr_t
 */
WEAK merr_t platform_spi_slave_init( platform_spi_slave_driver_t* driver, const platform_spi_t* peripheral, const platform_spi_slave_config_t* config );
...
WEAK merr_t platform_spi_slave_deinit( platform_spi_slave_driver_t* driver );
 ...
 * @return @ref merr_t
 */
WEAK merr_t platform_spi_slave_receive_command( platform_spi_slave_driver_t* driver, platform_spi_slave_command_t* command, uint32_t timeout_ms );
 ...
 * @return @ref merr_t
 */
WEAK merr_t platform_spi_slave_transfer_data( platform_spi_slave_driver_t* driver, platform_spi_slave_transfer_direction_t direction, platform_spi_slave_data_buffer_t* buffer, uint32_t timeout_ms );
 ...
 * @return @ref merr_t
 */
WEAK merr_t platform_spi_slave_send_error_status( platform_spi_slave_driver_t* driver, platform_spi_slave_transfer_status_t error_status );
 ...
 * @return @ref merr_t
 */
WEAK merr_t platform_spi_slave_generate_interrupt( platform_spi_slave_driver_t* driver, uint32_t pulse_duration_ms );
 ...
 * @return @ref merr_t
 */
merr_t platform_adc_init( const platform_adc_t* adc, uint32_t sample_cycle );
 ...
 * @return @ref merr_t
 */
merr_t platform_adc_deinit( const platform_adc_t* adc );
 ...
 * @return @ref merr_t
 */
merr_t platform_adc_take_sample( const platform_adc_t* adc, uint16_t* output );
 ...
 * @return @ref merr_t
 */
merr_t platform_adc_take_sample_stream( const platform_adc_t* adc, void* buffer, uint16_t buffer_length );
 ...
 * @return @ref merr_t
 */
merr_t platform_pwm_init( const platform_pwm_t* pwm, uint32_t frequency, float duty_cycle );
 ...
 * @return @ref merr_t
 */
merr_t platform_pwm_start( const platform_pwm_t* pwm );
 ...
 * @return @ref merr_t
 */
merr_t platform_pwm_stop( const platform_pwm_t* pwm );
 ...
 * @return @ref merr_t
 */
merr_t platform_stdio_init ( platform_uart_driver_t* driver, const platform_uart_t* interface, const platform_uart_config_t* config );
 ...
 *
 */
merr_t platform_flash_write( const platform_flash_t *peripheral, volatile uint32_t* start_address, uint8_t* data ,uint32_t length  );
