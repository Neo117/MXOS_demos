...
******************************************************/
merr_t platform_pwm_power( platform_pwm_driver_t *driver,int enable );
/******************************************************
*               Function Definitions
******************************************************/

merr_t platform_pwm_init( platform_pwm_driver_t *driver,const platform_pwm_t* pwm, uint32_t frequency, float duty_cycle )
{
  merr_t err = kNoErr;
  int duty = 0;
...
merr_t platform_pwm_start( platform_pwm_driver_t* driver )
{
  merr_t err = kNoErr;
...
merr_t platform_pwm_stop( platform_pwm_driver_t *driver )
{
  merr_t err = kNoErr;
