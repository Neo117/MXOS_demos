...
static merr_t i2c_address_device( platform_i2c_driver_t* driver, const platform_i2c_config_t* config, int retries, uint8_t direction );

/******************************************************
*               Function Declarations
******************************************************/
merr_t platform_i2c_init( platform_i2c_driver_t* driver, const platform_i2c_t* i2c, const platform_i2c_config_t* config )
{
	merr_t err = kNoErr;
	int hz = 100000;
...
static merr_t i2c_transfer_message( platform_i2c_driver_t* driver, const platform_i2c_config_t* config,
...
merr_t platform_i2c_transfer( platform_i2c_driver_t* driver, const platform_i2c_config_t* config, platform_i2c_message_t* messages, uint16_t number_of_messages )
{
  	merr_t err = kNoErr;
...
merr_t platform_i2c_deinit( platform_i2c_driver_t* driver, const platform_i2c_config_t* config )
{
