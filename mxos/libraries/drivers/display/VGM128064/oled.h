...
//----------------- OLED PIN ----------------  	
#define OLED_DC_INIT()     mhal_gpio_open( (int)OLED_SPI_DC, OUTPUT_PUSH_PULL )  // in case spi flash is wrote

#define OLED_CS_Clr()      mhal_gpio_low(OLED_SPI_CS)  //CS
#define OLED_CS_Set()      mhal_gpio_high(OLED_SPI_CS)

#define OLED_DC_Clr()      mhal_gpio_low(OLED_SPI_DC)  //DC
#define OLED_DC_Set()      mhal_gpio_high(OLED_SPI_DC)
...
#define OLED_SCLK_Clr() mhal_gpio_low(OLED_SPI_SCK)  //CLK
#define OLED_SCLK_Set() mhal_gpio_high(OLED_SPI_SCK)

#define OLED_SDIN_Clr() mhal_gpio_low(OLED_SPI_DIN)  //DIN
#define OLED_SDIN_Set() mhal_gpio_high(OLED_SPI_DIN)
