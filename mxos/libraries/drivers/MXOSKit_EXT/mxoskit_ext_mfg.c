 ...
 * @version V1.0.0
 * @date    8-May-2015
 * @brief   mxoskit extension board manufacture test operations..
 ******************************************************************************
 * @attention
 *
...
static void mxos_notify_WifiScanCompleteHandler( int num, mwifi_ap_info_t *ap_list)
{
    char str[32] = { '\0' };
    ap_list[0].ssid[10] = '\0';  // truncate first 10 char
