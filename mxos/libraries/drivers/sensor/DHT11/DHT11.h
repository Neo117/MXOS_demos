...
/** @defgroup MXOS_DHT11_Driver MXOS DHT11 Driver
  * @brief Provide driver interface for DHT11 Sensor 
  * @{
  */

#ifndef DHT11_DATA
#define DHT11_DATA             MXOS_GPIO_NONE
#endif

// Set GPIO Direction
#define DHT11_IO_IN()          mhal_gpio_open( (int)DHT11_DATA, INPUT_PULL_UP );										 
#define DHT11_IO_OUT()         mhal_gpio_open( (int)DHT11_DATA, OUTPUT_PUSH_PULL );
	
// Set Data output state
#define DHT11_DATA_Clr()       mhal_gpio_low(DHT11_DATA) 
#define DHT11_DATA_Set()       mhal_gpio_high(DHT11_DATA)

// get DATA input state
#define	DHT11_DQ_IN            mhal_gpio_value(DHT11_DATA)
