...
#if (defined(MXOS_BTE_CLASSICAL) && (MXOS_BTE_CLASSICAL == 1))
...
#define GKI_NUM_FIXED_BUF_POOLS         MXOS_BT_CFG_NUM_BUF_POOLS
#define GKI_NUM_TOTAL_BUF_POOLS         MXOS_BT_CFG_NUM_BUF_POOLS
