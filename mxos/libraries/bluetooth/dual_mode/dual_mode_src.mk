...
BTE_AVRC_SOURCES := \
		...
		$(BTEDIR)/mxos_bt_api/mxos_bt_avrc_wrapper.c
...
BTE_A2DP_SOURCES := \
		...
		$(BTEDIR)/mxos_bt_api/mxos_bt_a2d_wrapper.c
...
BTE_AVDT_SOURCES := \
		...
		$(BTEDIR)/mxos_bt_api/mxos_bt_avdt_wrapper.c
...
BTE_GATT_SMP_SOURCES := \
		...
		$(BTEDIR)/mxos_bt_api/mxos_bt_l2c_le_wrapper.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_ble_wrapper.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_dev_wrapper.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_gatt_wrapper.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_rfcomm_wrapper.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_sdp_wrapper.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_gatt.c \
		$(BTEDIR)/mxos_bt_api/mxos_bt_sdp.c
...
GKI_SOURCES := \
		...
		$(BTEDIR)/Components/gki/mxos/gki_mxos.c

UDRV_SOURCES := \
		$(BTEDIR)/Components/udrv/mxos/userial_mxos.c
...
BTEINCLUDES := \
        ...
        $(BTEDIR)/Components/gki/mxos \
		$(BTEDIR)/Components/gki/common \
		$(BTEDIR)/Components/udrv/include 
		

$(NAME)_SOURCES := 	\
					$(BTEDIR)/mxos_bt_api/mxos_bt_main.c \
					$(GKI_SOURCES) \
					$(BTESOURCES) \
					$(BTE_GATT_SMP_SOURCES) \
					$(BTE_RFCOMM_SOURCES) \
...
$(NAME)_SOURCES +=	$(BTEDIR)/Projects/bte/embedded/mxos/lib/mxos_post_reset.c \
					$(BTEDIR)/Projects/bte/embedded/mxos/lib/mxos_stubs.c
