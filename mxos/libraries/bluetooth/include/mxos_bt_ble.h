...
typedef uint8_t mxos_bt_ble_chnl_map_t[CHNL_MAP_LEN];

/** Scan modes */
enum mxos_bt_ble_scan_mode_e
{
    BTM_BLE_SCAN_MODE_PASSIVE = 0,  /**< Passive scan mode */
    BTM_BLE_SCAN_MODE_ACTIVE = 1,   /**< Active scan mode */
    BTM_BLE_SCAN_MODE_NONE = 0xff   /**< None */
};
typedef uint8_t mxos_bt_ble_scan_mode_t;   /**< scan mode (see #mxos_bt_ble_scan_mode_e) */

/** Scan filter policy */
enum mxos_bt_ble_scan_filter_policy_e 
{
...
typedef uint8_t mxos_bt_ble_scan_filter_policy_t; /**< scan filter policy (see #mxos_bt_ble_scan_filter_policy_e) */

/** advertising channel map */
enum mxos_bt_ble_advert_chnl_map_e
{
...
typedef uint8_t mxos_bt_ble_advert_chnl_map_t;  /**< BLE advertisement channel map (see #mxos_bt_ble_advert_chnl_map_e) */
...
enum mxos_bt_ble_advert_filter_policy_e {
...
typedef uint8_t   mxos_bt_ble_advert_filter_policy_t;  /**< Advertising filter policy (see #mxos_bt_ble_advert_filter_policy_e) */
...
typedef uint8_t mxos_dev_ble_signature_t[BTM_BLE_AUTH_SIGNATURE_SIZE];     /**< Device address (see #BTM_BLE_AUTH_SIGNATURE_SIZE) */
...
enum mxos_bt_ble_advert_mask_e {
...
typedef uint32_t mxos_bt_ble_advert_mask_t;        /**< BLE advertisement mask (see #mxos_bt_ble_advert_mask_e) */


/** Advertisement data types */
enum mxos_bt_ble_advert_type_e {
...
typedef uint8_t   mxos_bt_ble_advert_type_t;    /**< BLE advertisement data type (see #mxos_bt_ble_advert_type_e) */

/** security settings used with L2CAP LE COC */
enum mxos_bt_ble_sec_flags_e
{
...
typedef struct
{
    mxos_bt_uuid_t service_uuid;   /**< Service UUID data */
    uint8_t         len;            /**< Service UUID length */
    uint8_t         *p_val;         /**< Service data value */
}mxos_bt_ble_service_data_t;
...
}mxos_bt_ble_prop_elem_t;

/** Proprietary data elements structure supported in the device */
typedef struct
{
    uint8_t                     num_elem;   /**< Number of elements */
    mxos_bt_ble_prop_elem_t    *p_elem;    /**< Proprietary elements */
}mxos_bt_ble_proprietary_t;

/** Advertising data */
typedef struct
{
    mxos_bt_ble_int_range_t    int_range;              /**< slave preferred connection interval range (BTM_BLE_ADVERT_BIT_INTERVAL_RANGE) */
    mxos_bt_ble_manu_t         *p_manu;                /**< manufacturer data (BTM_BLE_ADVERT_BIT_MANUFACTURER) */
    mxos_bt_ble_service_t      *p_services;            /**< list of supported services - 16 bit UUIDs (BTM_BLE_ADVERT_BIT_SERVICE) */
    mxos_bt_ble_128service_t   *p_services_128b;       /**< list of supported services - 128 bit UUIDs (BTM_BLE_ADVERT_BIT_SERVICE_128) */
    mxos_bt_ble_32service_t    *p_service_32b;         /**< list of supported services - 32 bit UUIDs (BTM_BLE_ADVERT_BIT_SERVICE_32) */
    mxos_bt_ble_service_t      *p_sol_services;        /**< list of solicited services - 16 bit UUIDs (BTM_BLE_ADVERT_BIT_SERVICE_SOLICITATION) */
    mxos_bt_ble_32service_t    *p_sol_service_32b;     /**< list of solicited services - 32 bit UUIDs (BTM_BLE_ADVERT_BIT_SERVICE_32SOLICITATION) */
    mxos_bt_ble_128service_t   *p_sol_service_128b;    /**< list of solicited services - 128 bit UUIDs (BTM_BLE_ADVERT_BIT_SERVICE_128SOLICITATION) */
    mxos_bt_ble_proprietary_t  *p_proprietary;         /**< list of proprietary data elements (BTM_BLE_ADVERT_BIT_PROPRIETARY) */
    mxos_bt_ble_service_data_t *p_service_data;        /**< service data (BTM_BLE_ADVERT_BIT_SERVICE_DATA) */
...
}mxos_bt_ble_advert_data_t;

/** Scan result event type */
enum mxos_bt_dev_ble_evt_type_e {
...
typedef uint8_t mxos_bt_dev_ble_evt_type_t;    /**< Scan result event value (see #mxos_bt_dev_ble_evt_type_e) */

/** Background connection type */
enum mxos_bt_ble_conn_type_e
{
    BTM_BLE_CONN_NONE,                          /**< No background connection */
    BTM_BLE_CONN_AUTO,                          /**< Auto connection */
    BTM_BLE_CONN_SELECTIVE                      /**< Selective connection */
};
typedef uint8_t mxos_bt_ble_conn_type_t;       /**< Connection type (see #mxos_bt_ble_conn_type_e) */
...
typedef struct
{
    ...
    mxos_bt_dev_ble_evt_type_t     ble_evt_type;                           /**< Scan result event type */
    int8_t                          rssi;                                   /**< Set to #BTM_INQ_RES_IGNORE_RSSI, if not valid */
    uint8_t                         flag;
    uint8_t                         length;
} mxos_bt_ble_scan_results_t;

/**
 * Callback mxos_bt_ble_selective_conn_cback_t
 *
 * Selective connection callback (registered with  #mxos_bt_ble_set_background_connection_type)
 *
 ...
 * @return
 */
typedef bool (mxos_bt_ble_selective_conn_cback_t)(mxos_bt_device_address_t remote_bda, uint8_t *p_remote_name, const uint8_t *p_data, uint8_t length);


/**
 * Callback mxos_bt_ble_scan_result_cback_t
 *
 * Scan result callback (from calling #mxos_bt_ble_scan)
 *
 * @param p_scan_result             : scan result data (NULL indicates end of scanning)
 * @param p_adv_data                : Advertisement data (parse using #mxos_bt_ble_check_advertising_data)
 *
 * @return Nothing
 */
typedef void (mxos_bt_ble_scan_result_cback_t) (mxos_bt_ble_scan_results_t *p_scan_result, uint8_t *p_adv_data);
...
/**
 *
 * Function         mxos_bt_start_advertisements
 *
 *                  Start advertising.
 *
 *                  Use #mxos_bt_ble_set_advertisement_data to configure advertising data
 ...
 *
 */
mxos_bt_result_t mxos_bt_start_advertisements(mxos_bt_ble_advert_mode_t advert_mode, mxos_bt_ble_address_type_t directed_advertisement_bdaddr_type, mxos_bt_device_address_ptr_t directed_advertisement_bdaddr_ptr);

/**
 *
 * Function         mxos_bt_ble_get_current_advert_mode
 *
 ...
 *
 */
mxos_bt_ble_advert_mode_t mxos_bt_ble_get_current_advert_mode(void);


/**
 *
 * Function         mxos_bt_ble_set_advertisement_data
 *
 ...
 *
 */
mxos_bt_result_t mxos_bt_ble_set_advertisement_data(mxos_bt_ble_advert_mask_t  data_mask,
                                              mxos_bt_ble_advert_data_t *p_data);

/**
 *
 * Function         mxos_bt_ble_set_scan_response_data
 *
 ...
 *
 */
mxos_bt_dev_status_t mxos_bt_ble_set_scan_response_data(mxos_bt_ble_advert_mask_t data_mask,
                                               mxos_bt_ble_advert_data_t *p_data);

/**
 * Function         mxos_bt_ble_scan
 *
 *                  Start LE scanning
 *
 ...
 */
mxos_bt_result_t  mxos_bt_ble_scan (mxos_bt_ble_scan_type_t scan_type, mxos_bool_t duplicate_filter_enable, mxos_bt_ble_scan_result_cback_t *p_scan_result_cback);

/**
 *
 * Function         mxos_bt_ble_get_current_scan_state
 *
 *                  Get current scan state
 *
 * @return          mxos_bt_ble_scan_type_t
 *
 ...
 */
mxos_bt_ble_scan_type_t mxos_bt_ble_get_current_scan_state(void);


/**
 *
 * Function         mxos_bt_ble_security_grant
 *
 ...
 *
 */
void mxos_bt_ble_security_grant(mxos_bt_device_address_t bd_addr, uint8_t res);

/**
 *
 * Function         mxos_bt_ble_data_signature
 *
 ...
 *
 */
mxos_bool_t mxos_bt_ble_data_signature (mxos_bt_device_address_t bd_addr, uint8_t *p_text, uint16_t len,
                                             mxos_dev_ble_signature_t signature);

/**
 *
 * Function         mxos_bt_ble_verify_signature
 *
 ...
 *
 */
mxos_bool_t mxos_bt_ble_verify_signature (mxos_bt_device_address_t bd_addr, uint8_t *p_orig,
                                            uint16_t len, uint32_t counter,
                                            uint8_t *p_comp);

/**
 *
 * Function         mxos_bt_ble_set_background_connection_type
 *
 ...
 *
 */
mxos_bool_t mxos_bt_ble_set_background_connection_type (mxos_bt_ble_conn_type_t conn_type, mxos_bt_ble_selective_conn_cback_t *p_select_cback);

/**
 *
 * Function         mxos_bt_ble_update_background_connection_device
 *
 ...
 *
 */
mxos_bool_t mxos_bt_ble_update_background_connection_device(mxos_bool_t add_remove, mxos_bt_device_address_t remote_bda);


/**
 *
 * Function         mxos_bt_ble_get_background_connection_device_size
 *
 *                  Get a size of white list for the AUTO or SELECTIVE Connection Procedure.
 *
 *  @param[out]     size: white list size
 *
 *  @return         MXOS_TRUE or MXOS_FALSE
 */
mxos_bool_t mxos_bt_ble_get_background_connection_device_size(uint8_t *size);


/**
 *
 * Function         mxos_bt_ble_check_advertising_data
 *
 *                  Parse advertising data (returned from scan results callback #mxos_bt_ble_scan_result_cback_t).
 ...
 *
 */
uint8_t *mxos_bt_ble_check_advertising_data( uint8_t *p_adv, mxos_bt_ble_advert_type_t type, uint8_t *p_length);

/**
 *
 * Function         mxos_bt_ble_enable_privacy
 *
 ...
 *
 */
void mxos_bt_ble_enable_privacy (mxos_bool_t enable);

/**
 *
 * Function         mxos_bt_ble_enable_mixed_privacy_mode
 *
 ...
 *
 */
void mxos_bt_ble_enable_mixed_privacy_mode(mxos_bool_t mixed_on);


/**
 *
 * Function         mxos_bt_ble_get_security_state
 *
 *                  Get security mode 1 flags and encryption key size for LE peer.
 *
 * @param[in]       bd_addr         : peer address
 * @param[out]      p_le_sec_flags  : security flags (see #mxos_bt_ble_sec_flags_e)
 * @param[out]      p_le_key_size   : encryption key size
 *
 * @return          TRUE if successful
 *
 */
mxos_bool_t mxos_bt_ble_get_security_state (mxos_bt_device_address_t bd_addr, uint8_t *p_le_sec_flags, uint8_t *p_le_key_size);

/**
 *
 * Function         mxos_bt_ble_update_advertising_white_list
 *
 ...
 *
 */
mxos_bool_t mxos_bt_ble_update_advertising_white_list(mxos_bool_t add, const mxos_bt_device_address_t remote_bda);

/**
 *
 * Function         mxos_bt_ble_update_advertisement_filter_policy
 *
 ...
 *  @return         void
 */
mxos_bool_t mxos_bt_ble_update_advertisement_filter_policy(mxos_bt_ble_advert_filter_policy_t advertising_policy);


/**
 *
 * Function         mxos_bt_ble_get_advertisement_white_list_size
 *
 ...
 *  @return         MXOS_TRUE or MXOS_FALSE
 */
mxos_bool_t mxos_bt_ble_get_advertisement_white_list_size(uint8_t *size);


/**
 *
 * Function         mxos_bt_ble_get_white_list_capability
 *
 ...
 *  @return         MXOS_TRUE or MXOS_FALSE
 */
mxos_bool_t mxos_bt_ble_get_white_list_capability(uint8_t *size);

/**
 *
 * Function         mxos_bt_ble_clear_white_list
 *
 ...
 *  @return         MXOS_TRUE or MXOS_FALSE
 */
mxos_bool_t mxos_bt_ble_clear_white_list(void);
