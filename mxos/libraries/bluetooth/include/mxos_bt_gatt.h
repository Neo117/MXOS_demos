...
/** @file
 *
 *  MXOS Generic Attribute (GATT) Application Programming Interface
 */
...
/** GATT Status Codes*/
enum mxos_bt_gatt_status_e
{
    MXOS_BT_GATT_SUCCESS                    = 0x00,         /**< Success */
    MXOS_BT_GATT_INVALID_HANDLE             = 0x01,         /**< Invalid Handle */
    MXOS_BT_GATT_READ_NOT_PERMIT            = 0x02,         /**< Read Not Permitted */
    MXOS_BT_GATT_WRITE_NOT_PERMIT           = 0x03,         /**< Write Not permitted */
    MXOS_BT_GATT_INVALID_PDU                = 0x04,         /**< Invalid PDU */
    MXOS_BT_GATT_INSUF_AUTHENTICATION       = 0x05,         /**< Insufficient Authentication */
    MXOS_BT_GATT_REQ_NOT_SUPPORTED          = 0x06,         /**< Request Not Supported */
    MXOS_BT_GATT_INVALID_OFFSET             = 0x07,         /**< Invalid Offset */
    MXOS_BT_GATT_INSUF_AUTHORIZATION        = 0x08,         /**< Insufficient Authorization */
    MXOS_BT_GATT_PREPARE_Q_FULL             = 0x09,         /**< Prepare Queue Full */
    MXOS_BT_GATT_NOT_FOUND                  = 0x0a,         /**< Not Found */
    MXOS_BT_GATT_NOT_LONG                   = 0x0b,         /**< Not Long Size */
    MXOS_BT_GATT_INSUF_KEY_SIZE             = 0x0c,         /**< Insufficient Key Size */
    MXOS_BT_GATT_INVALID_ATTR_LEN           = 0x0d,         /**< Invalid Attribute Length */
    MXOS_BT_GATT_ERR_UNLIKELY               = 0x0e,         /**< Error Unlikely */
    MXOS_BT_GATT_INSUF_ENCRYPTION           = 0x0f,         /**< Insufficient Encryption */
    MXOS_BT_GATT_UNSUPPORT_GRP_TYPE         = 0x10,         /**< Unsupported Group Type */
    MXOS_BT_GATT_INSUF_RESOURCE             = 0x11,         /**< Insufficient Resource */

    MXOS_BT_GATT_ILLEGAL_PARAMETER          = 0x87,         /**< Illegal Parameter */
    MXOS_BT_GATT_NO_RESOURCES               = 0x80,         /**< No Resources */
    MXOS_BT_GATT_INTERNAL_ERROR             = 0x81,         /**< Internal Error */
    MXOS_BT_GATT_WRONG_STATE                = 0x82,         /**< Wrong State */
    MXOS_BT_GATT_DB_FULL                    = 0x83,         /**< DB Full */
    MXOS_BT_GATT_BUSY                       = 0x84,         /**< Busy */
    MXOS_BT_GATT_ERROR                      = 0x85,         /**< Error */
    MXOS_BT_GATT_CMD_STARTED                = 0x86,         /**< Command Started */
    MXOS_BT_GATT_PENDING                    = 0x88,         /**< Pending */
    MXOS_BT_GATT_AUTH_FAIL                  = 0x89,         /**< Authentication Fail */
    MXOS_BT_GATT_MORE                       = 0x8a,         /**< More */
    MXOS_BT_GATT_INVALID_CFG                = 0x8b,         /**< Invalid Configuration */
    MXOS_BT_GATT_SERVICE_STARTED            = 0x8c,         /**< Service Started */
    MXOS_BT_GATT_ENCRYPED_MITM              = MXOS_BT_GATT_SUCCESS, /**< Encrypted MITM */
    MXOS_BT_GATT_ENCRYPED_NO_MITM           = 0x8d,         /**< Encrypted No MITM */
    MXOS_BT_GATT_NOT_ENCRYPTED              = 0x8e,         /**< Not Encrypted */
    MXOS_BT_GATT_CONGESTED                  = 0x8f,         /**< Congested */

                                                    /* 0xE0 ~ 0xFC reserved for future use */
    MXOS_BT_GATT_CCC_CFG_ERR                = 0xFD,         /**< Improper Client Char Configuration */
    MXOS_BT_GATT_PRC_IN_PROGRESS            = 0xFE,         /**< Procedure Already in Progress */
    MXOS_BT_GATT_OUT_OF_RANGE               = 0xFF,         /**< Value Out of Range */
};
typedef uint8_t mxos_bt_gatt_status_t;     /**< GATT status (see #mxos_bt_gatt_status_e) */


/** GATT Status Codes*/
enum mxos_bt_gatt_app_interface_e
{
    GATT_IF_FIXED_DB_GAP                    = 0x01,         
    GATT_IF_FIXED_DB_APP                    = 0x02,         
    GATT_IF_CLIENT                          = 0x03,         
};
typedef uint8_t mxos_bt_gatt_app_interface_t;     /**< GATT status (see #mxos_bt_gatt_status_e) */
...
enum mxos_bt_gatt_disconn_reason_e {
...
typedef uint16_t mxos_bt_gatt_disconn_reason_t;    /**< GATT disconnection reason (see #mxos_bt_gatt_disconn_reason_e) */
...
enum mxos_bt_gatt_client_char_config_e
{
...
typedef uint16_t mxos_bt_gatt_client_char_config_t;     /**< GATT client config (see #mxos_bt_gatt_client_char_config_e) */

/** characteristic descriptor: server configuration value */
#define GATT_SERVER_CONFIG_NONE               0x0000     /**< No broadcast   */
#define GATT_SERVER_CONFIG_BROADCAST          0x0001     /**< Broadcast      */
typedef uint16_t mxos_bt_gatt_server_char_config_t;     /**< GATT server config (see #mxos_bt_gatt_server_char_config_e) */


/**  GATT Characteristic Properties Mask */
enum mxos_bt_gatt_char_properties_e {
...
typedef uint8_t mxos_bt_gatt_char_properties_t;            /**< GATT characteristic properties mask (see #mxos_bt_gatt_char_properties_e) */
...
typedef uint8_t mxos_bt_gatt_auth_req_t;   /**< GATT authentication requirement (see #mxos_bt_gatt_auth_req_e)*/
...
typedef struct
{
    ...
    mxos_bt_gatt_auth_req_t    auth_req;                   /**< Authentication requirement (see @link mxos_bt_gatt_auth_req_e mxos_bt_gatt_auth_req_t @endlink) */
    uint8_t                     value[1];                   /**< The attribute value (actual length is specified by 'len') */
} mxos_bt_gatt_value_t;

/** GATT Write Execute request flags */
enum mxos_bt_gatt_exec_flag_e {
    GATT_PREP_WRITE_CANCEL      = 0x00,         /**< GATT_PREP_WRITE_CANCEL */
    GATT_PREP_WRITE_EXEC        = 0x01          /**< GATT_PREP_WRITE_EXEC */
};
typedef uint8_t   mxos_bt_gatt_exec_flag_t;    /**< GATT execute flag (see #mxos_bt_gatt_exec_flag_e) */
...
typedef struct
{
    ...
    mxos_bool_t    is_long;    /**< TRUE if long read */
...
{
    uint16_t      handle;     /**< Handle of attribute to read */
    mxos_bool_t   is_prep;    /**< TRUE if this is a prepare write request */
    uint16_t      offset;     /**< Offset to write */
    uint16_t      val_len;    /**< Value length */
    uint8_t       *p_val;     /**< Value pointer */
} mxos_bt_gatt_write_t;

/** Attribute information for GATT attribute requests */
typedef union
{
    mxos_bt_gatt_read_t             read_req;                       /**< Parameters for GATTS_REQ_TYPE_READ */
    mxos_bt_gatt_write_t            write_req;                      /**< Parameters for GATTS_REQ_TYPE_WRITE */
    uint16_t                        handle;                         /**< Parameters for GATTS_REQ_TYPE_CONF */
    uint16_t                        mtu;                            /**< Parameters for GATTS_REQ_TYPE_MTU */
    mxos_bt_gatt_exec_flag_t        exec_write;                     /**< Parameters for GATTS_REQ_TYPE_WRITE_EXEC */
} mxos_bt_gatt_request_data_t;

/** GATT Attribute Request Type */
enum mxos_bt_gatt_request_type_e
{
...
typedef uint8_t mxos_bt_gatt_request_type_t;   /**< GATT Attribute Request Type (see #mxos_bt_gatt_request_type_e) */

/** Discovery types */
enum mxos_bt_gatt_discovery_type_e
{
...
typedef uint8_t mxos_bt_gatt_discovery_type_t;    /**< GATT Discovery type (see #mxos_bt_gatt_discovery_type_e) */

/** Parameters used in a GATT Discovery */
typedef struct
{
    mxos_bt_uuid_t uuid;        /**< Service or Characteristic UUID */
    uint16_t        s_handle;    /**< Start handle for range to search */
    uint16_t        e_handle;    /**< End handle for range to search */
}mxos_bt_gatt_discovery_param_t;

/** GATT Read Types */
enum mxos_bt_gatt_read_type_e
{
...
typedef uint8_t mxos_bt_gatt_read_type_t;      /**< GATT read type (see #mxos_bt_gatt_read_type_e) */
...
typedef struct
{
    ...
    mxos_bt_uuid_t              uuid;           /**< uuid */
} mxos_bt_gatt_read_by_type_t;
...
} mxos_bt_gatt_read_partial_t;

/** Read request parameters - used when calling #mxos_bt_gatt_send_read */
typedef union
{
    mxos_bt_gatt_read_by_type_t   service;           /**< Parameters for GATT_READ_BY_TYPE */
    mxos_bt_gatt_read_by_type_t   char_type;         /**< Parameters for GATT_READ_CHAR_VALUE */
    mxos_bt_gatt_read_multi_t     read_multiple;     /**< Parameters for GATT_READ_MULTIPLE */
    mxos_bt_gatt_read_by_handle_t by_handle;         /**< Parameters for GATT_READ_BY_HANDLE */
    mxos_bt_gatt_read_partial_t   partial;           /**< Parameters for GATT_READ_PARTIAL  */
} mxos_bt_gatt_read_param_t;

/**  Write request types - used when calling #mxos_bt_gatt_send_write */
enum mxos_bt_gatt_write_type_e
{
    GATT_WRITE_NO_RSP = 1,  /**< Write without response */
    GATT_WRITE,             /**< Write with response */
    GATT_WRITE_PREPARE      /**< Prepare to write (call #mxos_bt_gatt_send_execute_write to execute the write) */
};
typedef uint8_t mxos_bt_gatt_write_type_t;     /**< GATT write type (see #mxos_bt_gatt_write_type_e) */
...
typedef union
{
    mxos_bt_gatt_data_t    att_value;      /**< Response data for read operations (initiated using #mxos_bt_gatt_send_read) */
    uint16_t                mtu;            /**< Response data for configuration operations */
    uint16_t                handle;         /**< Response data for write operations (initiated using #mxos_bt_gatt_send_write) */
} mxos_bt_gatt_operation_complete_rsp_t;   /**< GATT operation complete response type */

/** GATT client operation type, used in client callback function
*/
enum mxos_bt_gatt_optype_e
{
...
typedef uint8_t mxos_bt_gatt_optype_t; /**< GATT operation type (see #mxos_bt_gatt_optype_e) */

/** characteristic declaration */
typedef struct
{
    mxos_bt_gatt_char_properties_t characteristic_properties;  /**< characteristic properties (see @link mxos_bt_gatt_char_properties_e mxos_bt_gatt_char_properties_t @endlink) */
    uint16_t                        val_handle;                 /**< characteristic value attribute handle */
    uint16_t                        handle;                     /**< characteristic declaration handle */
    mxos_bt_uuid_t                 char_uuid;                  /**< characteristic UUID type */
} mxos_bt_gatt_char_declaration_t;

/** GATT group value */
typedef struct
{
    mxos_bt_uuid_t service_type;   /**< group type */
    uint16_t        s_handle;       /**< starting handle of the group */
    uint16_t        e_handle;       /**< ending handle of the group */
} mxos_bt_gatt_group_value_t;


/** included service attribute value */
typedef struct
{
    mxos_bt_uuid_t service_type;   /**< included service UUID */
    uint16_t        handle;         /**< included service handle */
    uint16_t        s_handle;       /**< starting handle */
    uint16_t        e_handle;       /**< ending handle */
} mxos_bt_gatt_included_service_t;

/** characteristic descriptor information */
typedef struct
{
    mxos_bt_uuid_t         type;      /**< descriptor UUID type */
    uint16_t                handle;    /**< descriptor attribute handle */
}mxos_bt_gatt_char_descr_info_t;
...
typedef union
{
    mxos_bt_gatt_included_service_t    included_service;           /**< Result for GATT_DISCOVER_INCLUDED_SERVICES */
    mxos_bt_gatt_group_value_t         group_value;                /**< Result for GATT_DISCOVER_SERVICES_ALL or GATT_DISCOVER_SERVICES_BY_UUID  */
    mxos_bt_gatt_char_declaration_t    characteristic_declaration; /**< Result for GATT_DISCOVER_CHARACTERISTICS */
    mxos_bt_gatt_char_descr_info_t     char_descr_info;            /**< Result for GATT_DISCOVER_CHARACTERISTIC_DESCRIPTORS */
} mxos_bt_gatt_discovery_data_t;
...
typedef uint16_t mxos_bt_gatt_appearance_t;     /**< GATT appearance (see #gatt_appearance_e) */
...
typedef enum
{
    GATT_CONNECTION_STATUS_EVT,                         /**< GATT connection status change. Event data: #mxos_bt_gatt_connection_status_t */
    GATT_OPERATION_CPLT_EVT,                            /**< GATT operation complete. Event data: #mxos_bt_gatt_event_data_t */
    GATT_DISCOVERY_RESULT_EVT,                          /**< GATT attribute discovery result. Event data: #mxos_bt_gatt_discovery_result_t */
    GATT_DISCOVERY_CPLT_EVT,                            /**< GATT attribute discovery complete. Event data: #mxos_bt_gatt_event_data_t */
    GATT_ATTRIBUTE_REQUEST_EVT                          /**< GATT attribute request (from remote client). Event data: #mxos_bt_gatt_attribute_request_t */
} mxos_bt_gatt_evt_t;
...
typedef struct
{
    ...
    mxos_bt_gatt_discovery_type_t          discovery_type;     /**< Discovery type (see @link mxos_bt_gatt_discovery_type_e mxos_bt_gatt_discovery_type_t @endlink) */
    mxos_bt_gatt_discovery_data_t          discovery_data;     /**< Discovery data  */
} mxos_bt_gatt_discovery_result_t;

/** Discovery Complete (used by GATT_DISCOVERY_CPLT_EVT notification) */
typedef struct
{
    uint16_t                                conn_id;            /**< ID of the connection */
    mxos_bt_gatt_discovery_type_t          disc_type;          /**< Discovery type (see @link mxos_bt_gatt_discovery_type_e mxos_bt_gatt_discovery_type_t @endlink) */
    mxos_bt_gatt_status_t                  status;             /**< Status of operation */
} mxos_bt_gatt_discovery_complete_t;

/** Response to read/write/disc/config operations (used by GATT_OPERATION_CPLT_EVT notification) */
typedef struct
{
    uint16_t                                conn_id;            /**< ID of the connection */
    mxos_bt_gatt_optype_t                  op;                 /**< Type of operation completed (see @link mxos_bt_gatt_optype_e mxos_bt_gatt_optype_t @endlink) */
    mxos_bt_gatt_status_t                  status;             /**< Status of operation */
    mxos_bt_gatt_operation_complete_rsp_t  response_data;      /**< Response data (dependent on optype) */
} mxos_bt_gatt_operation_complete_t;

/** GATT connection status (used by GATT_CONNECTION_STATUS_EVT notification) */
typedef struct
{
    uint8_t                         *bd_addr;               /**< Remote device address */
    mxos_bt_ble_address_type_t     addr_type;              /**< Remmote device address type */
    uint16_t                        conn_id;                /**< ID of the connection */
    mxos_bool_t                    connected;              /**< TRUE if connected, FALSE if disconnected */
    mxos_bt_gatt_disconn_reason_t  reason;                 /**< Reason code (see @link mxos_bt_gatt_disconn_reason_e mxos_bt_gatt_disconn_reason_t @endlink) */
    mxos_bt_transport_t            transport;              /**< Transport type of the connection */
    uint8_t                         link_role;              /**< Link role on this connection */
} mxos_bt_gatt_connection_status_t;

/** GATT attribute request (used by GATT_ATTRIBUTE_REQUEST_EVT notification) */
typedef struct
{
    uint16_t                                conn_id;            /**< ID of the connection */
    mxos_bt_gatt_request_type_t            request_type;       /**< Request type (see @link mxos_bt_gatt_request_type_e mxos_bt_gatt_request_type_t)  */
    mxos_bt_gatt_request_data_t            data;               /**< Information about attribute being request (dependent on request type) */
} mxos_bt_gatt_attribute_request_t;

/** Stuctures for GATT event notifications */
typedef union
{
    mxos_bt_gatt_discovery_result_t        discovery_result;   /**< Data for GATT_DISCOVERY_RESULT_EVT */
    mxos_bt_gatt_discovery_complete_t      discovery_complete; /**< Data for GATT_DISCOVERY_CPLT_EVT */
    mxos_bt_gatt_operation_complete_t      operation_complete; /**< Data for GATT_OPERATION_CPLT_EVT */
    mxos_bt_gatt_connection_status_t       connection_status;  /**< Data for GATT_CONNECTION_STATUS_EVT */
    mxos_bt_gatt_attribute_request_t       attribute_request;  /**< Data for GATT_ATTRIBUTE_REQUEST_EVT */
} mxos_bt_gatt_event_data_t;

/**
 * GATT event notification callback
 *
 * Callback for GATT event notifications
 * Registered using mxos_bt_gatt_register()
 *
...
*/
typedef mxos_bt_gatt_status_t mxos_bt_gatt_cback_t(mxos_bt_gatt_evt_t event, mxos_bt_gatt_event_data_t *p_event_data);
...
/**
 * @addtogroup  mxosbt_gatt   Generic Attribute (GATT)
 * @ingroup     mxosbt
 *
 ...
 *
 * @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_db_init (const uint8_t *p_gatt_db, uint16_t gatt_db_size);

/**
 *
 * Function     mxos_bt_gatt_send_indication
 *
 ...
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_send_indication (uint16_t conn_id, uint16_t attr_handle, uint16_t *val_len, uint8_t *p_val );

/**
 * Function     mxos_bt_gatt_send_notification
 *
 ...
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_send_notification (uint16_t conn_id, uint16_t attr_handle, uint16_t *val_len, uint8_t *p_val );

/**
* Function       mxos_bt_gatt_send_response
*
*                When application receives a Read Request, Write Request or Indication from the
*                peer it can reply synchronously or return a MXOS_BT_GATT_PENDING result code 
...
*  @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
*/
mxos_bt_gatt_status_t mxos_bt_gatt_send_response(mxos_bt_gatt_status_t status, uint16_t conn_id,
...
/**
 * Function       mxos_bt_gatt_configure_mtu
 *
 ...
 *  @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
*/
mxos_bt_gatt_status_t mxos_bt_gatt_configure_mtu (uint16_t conn_id, uint16_t mtu);

/**
 * Function       mxos_bt_gatt_send_discover
 *
 *                Start an attribute discovery on an ATT server.
 *                Discovery results are notified using <b> GATT_DISCOVERY_RESULT_EVT </b>;
 *                completion is notified using <b> GATT_DISCOVERY_CPLT_EVT </b> of #mxos_bt_gatt_cback_t.
 *
 *  @param[in]  conn_id             : GATT connection handle
 ...
 *  @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
*/
mxos_bt_gatt_status_t mxos_bt_gatt_send_discover (uint16_t conn_id,
                                             mxos_bt_gatt_discovery_type_t discovery_type,
                                             mxos_bt_gatt_discovery_param_t *p_discovery_param );

/**
 * Function       mxos_bt_gatt_send_read
 *
 *                Read from remote ATT server.
 *                Result is notified using <b> GATT_OPERATION_CPLT_EVT </b> of #mxos_bt_gatt_cback_t.
 *
 *  @param[in]  conn_id     : Connection handle
 ...
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_send_read (uint16_t conn_id, mxos_bt_gatt_read_type_t type,
                                             mxos_bt_gatt_read_param_t *p_read);

/**
 * Function       mxos_bt_gatt_send_write
 *
 ...
 *  @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
 */
mxos_bt_gatt_status_t mxos_bt_gatt_send_write (uint16_t conn_id, mxos_bt_gatt_write_type_t type,
                                              mxos_bt_gatt_value_t *p_write);

/**
 * Function       mxos_bt_gatt_send_execute_write
 *
 *                Send Execute Write request to remote ATT server.
 *
 *  @param[in]  conn_id             : Connection handle
 *  @param[in]  is_execute          : <b>MXOS_BT_TRUE </b> to execute, <b> MXOS_BT_FALSE </b> to cancel
 *
 *  @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_send_execute_write (uint16_t conn_id, mxos_bool_t is_execute);

/**
 * Function       mxos_bt_gatt_send_indication_confirm
 *
 *                Send a handle value confirmation to remote ATT server.
 *                (in response to <b>GATTC_OPTYPE_INDICATION </b>  of #mxos_bt_gatt_cback_t)
 *
 *  @param[in]  conn_id             : Connection handle
 ...
 *  @return @link mxos_bt_gatt_status_e mxos_bt_gatt_status_t @endlink
*/
mxos_bt_gatt_status_t mxos_bt_gatt_send_indication_confirm (uint16_t conn_id, uint16_t handle);
...
/**
 * Function       mxos_bt_gatt_register
 *
 ...
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_register (mxos_bt_gatt_app_interface_t gatt_if, mxos_bt_gatt_cback_t *p_gatt_cback);

/**
 * Function       mxos_bt_gatt_deregister
 *
 ...
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_deregister (mxos_bt_gatt_app_interface_t gatt_if);


/**
 * Function       mxos_bt_gatt_le_connect
 *
 *                Open GATT over LE connection to a remote device
 *                Result is notified using <b> GATT_CONNECTION_STATUS_EVT </b> of #mxos_bt_gatt_cback_t.
 *
 ...
 *
 */
mxos_bool_t mxos_bt_gatt_le_connect (mxos_bt_device_address_t bd_addr,
                                    mxos_bt_ble_address_type_t bd_addr_type,
                                    mxos_bt_ble_conn_mode_t conn_mode,
                                    mxos_bool_t is_direct);

/**
 * Function       mxos_bt_gatt_bredr_connect
 *
 ...
 *
 */
mxos_bool_t mxos_bt_gatt_bredr_connect (mxos_bt_device_address_t bd_addr);

/**
 * Function       mxos_bt_gatt_cancel_connect
 *
 ...
 *
 */
mxos_bool_t mxos_bt_gatt_cancel_connect (mxos_bt_device_address_t bd_addr, mxos_bool_t is_direct);

/**
 * Function       mxos_bt_gatt_disconnect
 *
 ...
 *
 */
mxos_bt_gatt_status_t mxos_bt_gatt_disconnect (uint16_t conn_id);


/**
 * Function     mxos_bt_gatt_listen
 *
 ...
 *
 */
mxos_bool_t mxos_bt_gatt_listen (mxos_bool_t start, mxos_bt_device_address_t bd_addr);
