 ...
 *
 * @note
 * Additional information of the Descriptors can be read using @ref mxos_bt_smartbridge_gatt_read_characteristic_descriptor()
 * and @ref mxos_bt_smartbridge_gatt_read_long_characteristic_descriptor()
 *
 * @param[in]  socket          : socket that is connected to the server to discover
