...
#define ATTR_COMMON_FIELDS_SIZE         ( sizeof(mxos_bt_smart_attribute_t*) + sizeof(uint16_t) + sizeof(mxos_bt_uuid_t) + sizeof(uint8_t) + sizeof(uint32_t) + + sizeof(uint32_t))
...
typedef enum
{
    MXOS_ATTRIBUTE_TYPE_NO_VALUE,                                        /**< Attribute with no value                         */
    MXOS_ATTRIBUTE_TYPE_LONG_VALUE,                                      /**< Attribute with long value                       */
    MXOS_ATTRIBUTE_TYPE_PRIMARY_SERVICE,                                 /**< Primary service                                 */
    MXOS_ATTRIBUTE_TYPE_INCLUDE,                                         /**< Included Service                                */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC,                                  /**< Characteristic                                  */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_VALUE,                            /**< Characteristic Value                            */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_EXTENDED_PROPERTIES,   /**< Characteristic Descriptor: Extended Properties  */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_USER_DESCRIPTION,      /**< Characteristic Descriptor: User Description     */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_CLIENT_CONFIGURATION,  /**< Characteristic Descriptor: Client Configuration */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_SERVER_CONFIGURATION,  /**< Characteristic Descriptor: Server Configuration */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_PRESENTATION_FORMAT,   /**< Characteristic Descriptor: Presentation Format  */
    MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_AGGREGATE_FORMAT       /**< Characteristic Descriptor: Aggregate Format     */
} mxos_bt_smart_attribute_type_t;
 ...
 * Attribute Structure
 */
typedef struct mxos_bt_attribute
{
    struct mxos_bt_attribute*                   next;              /**< Pointer to the next attribute in the list. NULL if not a list */
    uint16_t                                    handle;            /**< Attribute Handle                                              */
    mxos_bt_uuid_t                              type;              /**< Attribute Type (UUID)                                         */
...
typedef struct
{
    ...
    mxos_bt_smart_attribute_t*  list;  /**< Pointer to attribute linked-list */
} mxos_bt_smart_attribute_list_t;
