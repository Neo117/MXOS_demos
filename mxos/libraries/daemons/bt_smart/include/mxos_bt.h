...
extern mos_worker_thread_id_t mxos_bt_worker_thread;
extern mos_worker_thread_id_t mxos_bt_evt_worker_thread;

#define MXOS_BT_WORKER_THREAD       ((mos_worker_thread_id_t *)&mxos_bt_worker_thread)
#define MXOS_BT_EVT_WORKER_THREAD   ((mos_worker_thread_id_t *)&mxos_bt_evt_worker_thread)
 ...
 *            MXOS_ERROR   : if an error occurred
 */
merr_t mxos_bt_start_mfgtest_mode( const mhal_uart_config_t* config );
