...
merr_t mxos_bt_smartbridge_gatt_write_characteristic_value_without_response( const mxos_bt_smartbridge_socket_t* socket, const mxos_bt_smart_attribute_t* characteristic_value )
{
...
merr_t mxos_bt_smartbridge_gatt_signed_write_characteristic_value_without_response( const mxos_bt_smartbridge_socket_t* socket, const mxos_bt_smart_attribute_t* characteristic_value )
{
    UNUSED_PARAMETER( socket );
    UNUSED_PARAMETER( characteristic_value );
    return MXOS_BT_UNSUPPORTED;
...
merr_t mxos_bt_smartbridge_gatt_reliable_write_characteristic_value( const mxos_bt_smartbridge_socket_t* socket, const mxos_bt_smart_attribute_t* characteristic_value )
{
    UNUSED_PARAMETER( socket );
    UNUSED_PARAMETER( characteristic_value );    
    return MXOS_BT_UNSUPPORTED;
