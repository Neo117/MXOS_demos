...
{
    [MXOS_ATTRIBUTE_TYPE_NO_VALUE                                      ] =  ATTR_NO_VALUE_SIZE,
    [MXOS_ATTRIBUTE_TYPE_LONG_VALUE                                    ] =  ATTR_LONG_VALUE_SIZE,
    [MXOS_ATTRIBUTE_TYPE_PRIMARY_SERVICE                               ] =  ATTR_SERVICE_SIZE,
    [MXOS_ATTRIBUTE_TYPE_INCLUDE                                       ] =  ATTR_INCLUDE_SIZE,
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC                                ] =  ATTR_CHARACTERISTIC_SIZE,
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_VALUE                          ] =  0, // Variable length
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_EXTENDED_PROPERTIES ] =  ATTR_EXTENDED_PROPERTIES_SIZE,
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_USER_DESCRIPTION    ] =  0, // Variable length
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_CLIENT_CONFIGURATION] =  ATTR_CLIENT_CONFIG_SIZE,
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_SERVER_CONFIGURATION] =  ATTR_SERVER_CONFIG_SIZE,
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_PRESENTATION_FORMAT ] =  ATTR_PRESENTATION_FORMAT_SIZE,
    [MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_AGGREGATE_FORMAT    ] =  0, // Variable length
};
...
static merr_t print_uuid( const mxos_bt_uuid_t* uuid );
static merr_t print_type( const mxos_bt_uuid_t* uuid );
...
merr_t mxos_bt_smart_attribute_create( mxos_bt_smart_attribute_t** attribute, mxos_bt_smart_attribute_type_t type, uint16_t variable_length )
{
    ...
    switch ( type )
    {
        case MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_VALUE:
        {
            size = ATTR_CHARACTERISTIC_VALUE_SIZE( variable_length );
            break;
        }
        case MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_USER_DESCRIPTION:
        {
            size = ATTR_USER_DESCRIPTION_SIZE( variable_length );
            break;
        }
        case MXOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_AGGREGATE_FORMAT:
        {
    ...
    *attribute = (mxos_bt_smart_attribute_t*)malloc_named("attribute", size );
...
merr_t mxos_bt_smart_attribute_add_to_list( mxos_bt_smart_attribute_list_t* list, mxos_bt_smart_attribute_t* attribute )
{
    ...
    {
        mxos_bt_smart_attribute_t* curr = list->list;
        mxos_bt_smart_attribute_t* prev = NULL;
    ...
    else
    {
        ...
        while ( curr != NULL )
        {
            if ( curr->handle == handle )
            {
                ...
                mxos_bt_smart_attribute_delete( curr );
...
merr_t mxos_bt_smart_attribute_delete_list( mxos_bt_smart_attribute_list_t* list )
{
    ...
    while ( curr != NULL )
    {
        ...
        mxos_bt_smart_attribute_t* next = curr->next;
...
merr_t mxos_bt_smart_attribute_merge_lists( mxos_bt_smart_attribute_list_t* trunk_list, mxos_bt_smart_attribute_list_t* branch_list )
{
    ...
    while ( curr != NULL )
    {
        mxos_bt_smart_attribute_t* prev = curr;
        ...
        mxos_bt_smart_attribute_add_to_list( trunk_list, prev );
    }
...
merr_t mxos_bt_smart_attribute_print_list( const mxos_bt_smart_attribute_list_t* list )
{
    ...
    {
        mxos_bt_smart_attribute_print( curr_attr );
