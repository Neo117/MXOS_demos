...
#define CONFIG_LWS_DEBUG_EXT        MXOS_DEBUG_ON
#define CONFIG_LWS_DEBUG_CLIENT     MXOS_DEBUG_ON
#define CONFIG_LWS_DEBUG_LATENCY    MXOS_DEBUG_ON
#else
...
#define lwsl_err(M, ...)    MXOS_LOG(CONFIG_LWS_DEBUG|MXOS_DEBUG_LEVEL_SEVERE, "LLL_ERROR", M, ##__VA_ARGS__)

/* notice, warn and log are always compiled in */
#define lwsl_warn(M, ...)      	MXOS_LOG(CONFIG_LWS_DEBUG|MXOS_DEBUG_LEVEL_WARNING, "LLL_WARN", M, ##__VA_ARGS__)
#define lwsl_notice(M, ...)    	MXOS_LOG(CONFIG_LWS_DEBUG|MXOS_DEBUG_LEVEL_ALL, "LLL_NOTICE", M, ##__VA_ARGS__)
#define lwsl_info(M,...) 		MXOS_LOG(CONFIG_LWS_DEBUG|MXOS_DEBUG_LEVEL_ALL, "LLL_INFO", M, ##__VA_ARGS__)
#define lwsl_debug(M,...) 		MXOS_LOG(CONFIG_LWS_DEBUG, "LLL_DEBUG", M, ##__VA_ARGS__)
#define lwsl_parser(M,...) 		MXOS_LOG(CONFIG_LWS_DEBUG_PARSER, "LLL_PARSER", M, ##__VA_ARGS__)
#define lwsl_header(M,...)  	MXOS_LOG(CONFIG_LWS_DEBUG_HEADER, "LLL_HEADER", M, ##__VA_ARGS__)
#define lwsl_ext(M,...)  		MXOS_LOG(CONFIG_LWS_DEBUG_EXT, "LLL_EXT", M, ##__VA_ARGS__)
#define lwsl_client(M,...) 		MXOS_LOG(CONFIG_LWS_DEBUG_CLIENT, "LLL_CLIENT", M, ##__VA_ARGS__)
#define lwsl_latency(M,...) 	MXOS_LOG(CONFIG_LWS_DEBUG_LATENCY, "LLL_LATENCY", M, ##__VA_ARGS__)
