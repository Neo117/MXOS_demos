...
#define TMP_BUF_LEN 1024
    ...
    mwifi_connect( DEFAULT_OTA_AP, "", 0, NULL, &ip_attr);
    ...
    fileinfo.flashtype = MODULE_PARTITION_OTA_TEMP;
    ...
    flashaddr = filelen;
    mhal_flash_read(MODULE_PARTITION_OTA_TEMP, &flashaddr, (uint8_t *)md5_recv, 16);
    InitMd5( &ctx );
    CRC16_Init( &contex );
    flashaddr = 0;
    left = filelen;
