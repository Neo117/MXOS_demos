...
extern int mfg_connect (char *ssid);  //TODO: Get it from MXOS core libraries
extern void mfg_option (int use_udp, uint32_t remoteaddr);  //TODO: Get it from MXOS core libraries
