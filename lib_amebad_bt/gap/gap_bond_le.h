      ...
      case GAP_MSG_LE_BOND_PASSKEY_DISPLAY:
          {
            ...
            app_log("GAP_MSG_LE_BOND_PASSKEY_DISPLAY:passkey %d", display_value);
      ...
      case GAP_MSG_LE_BOND_PASSKEY_INPUT:
          {
              ...
              app_log("GAP_MSG_LE_BOND_PASSKEY_INPUT");
        ...
        case GAP_MSG_LE_BOND_USER_CONFIRMATION:
          {
            ...
            le_bond_get_display_key(conn_id, &display_value);
            app_log("GAP_MSG_LE_BOND_USER_CONFIRMATION: passkey %d", display_value);
 ...
 * \code{.c}
    ...
    {
        app_log("app_handle_bond_modify_msg  GAP_MSG_LE_BOND_MODIFY_INFO:type=0x%x",
                        type);
