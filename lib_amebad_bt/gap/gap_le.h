 ...
 * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        app_log("app_gap_callback: msgType = %d", cb_type);
        switch (cb_type)
        {
        ...
        case GAP_MSG_LE_GAP_STATE_MSG:
            app_log("GAP_MSG_LE_GAP_STATE_MSG");
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_MODIFY_WHITE_LIST:
           app_log("GAP_MSG_LE_MODIFY_WHITE_LIST: operation  0x%x, cause 0x%x",
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_SET_RAND_ADDR:
            app_log("GAP_MSG_LE_SET_RAND_ADDR: cause 0x%x",
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_SET_HOST_CHANN_CLASSIF:
           app_log("GAP_MSG_LE_SET_HOST_CHANN_CLASSIF: cause 0x%x",
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_WRITE_DEFAULT_DATA_LEN:
           app_log("GAP_MSG_LE_WRITE_DEFAULT_DATA_LEN: cause 0x%x",
