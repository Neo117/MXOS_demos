        ...
        case GAP_CONN_STATE_CONNECTED:
            {
                ...
                app_log("GAP_CONN_STATE_CONNECTED:remote_bd %s, remote_addr_type %d, conn_interval 0x%x, conn_latency 0x%x, conn_supervision_timeout 0x%x",
 ...
 * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        app_log("app_gap_callback: cb_type = %d", cb_type);
        switch (cb_type)
        {
        ...
        case GAP_MSG_LE_READ_RSSI:
          app_log("GAP_MSG_LE_READ_RSSI: conn_id 0x%x, cause 0x%x, rssi %d",
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_SET_DATA_LEN:
           app_log("GAP_MSG_LE_SET_DATA_LEN: conn_id 0x%x, cause 0x%x",
                           cb_data.p_le_set_data_len_rsp->conn_id,
                           cb_data.p_le_set_data_len_rsp->cause);
           break;
        case GAP_MSG_LE_DATA_LEN_CHANGE_INFO:
           app_log("GAP_MSG_LE_DATA_LEN_CHANGE_INFO: conn_id 0x%x, max_tx_octets 0x%x, max_tx_time 0x%x,
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_PHY_UPDATE_INFO:
            app_log("GAP_MSG_LE_PHY_UPDATE_INFO:conn %d, cause 0x%x, rx_phy %d, tx_phy %d",
 ...
 * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
       ...
       case GAP_MSG_LE_REMOTE_FEATS_INFO:
           app_log("GAP_MSG_LE_REMOTE_FEATS_INFO: conn id %d, cause 0x%x, remote_feats %b",
  ...
  * \code{.c}
    ...
    T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
    {
        ...
        case GAP_MSG_LE_CONN_UPDATE_IND:
           app_log("GAP_MSG_LE_CONN_UPDATE_IND: conn_interval_max 0x%x, conn_interval_min 0x%x, conn_latency 0x%x
